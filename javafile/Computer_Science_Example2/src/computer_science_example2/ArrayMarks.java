 ...
 */
package computer_science_example2;
class student
{
	public String ID;
	...
	public void grade(double d) {
		...
		for(int i=0;i<courseIds.length; i++){
			sum=sum+fMark(courseIds[i]);
		}
		average=sum/(courseIds.length);
	}
	...
	public void print()
	{
		...
		System.out.println("\n\n");
                System.out.println("Final Marks Average : "+average);
	}
	        ...
	        {  
	            double minvalue=10000;
                    ...
                    for(int j=0; j<s.length; j++){
                        if(s[j].average>minvalue){
                            minvalue=s[j].average;
                            s[j].print();
                        }
                    }
