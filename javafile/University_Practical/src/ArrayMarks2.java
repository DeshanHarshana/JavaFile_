...
class ArrayMarks2
{
	...
	public static void main(String [] args)
	{
		...
		students[0].setMarks("CSC102S2","ICA1",45);
		students[0].setMarks("CSC102S2","ICA2",88);
		students[0].setMarks("CSC102S2","EC",36);
		
		
		students[1]=new student(" 2018/CSC/002");
		students[1].setMarks("CSC101S3","ICA1",80);
		students[1].setMarks("CSC101S3","ICA2",78);
		students[1].setMarks("CSC101S3","EC",80);
		students[1].setMarks("CSC102S2","ICA1",65);
		students[1].setMarks("CSC102S2","ICA2",87);
		students[1].setMarks("CSC102S2","EC",34);
